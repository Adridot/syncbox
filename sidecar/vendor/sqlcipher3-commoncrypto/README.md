...
> Syncbox vendor note: this is preserved upstream `sqlcipher3` 0.6.2 prose.
> References below to the "latest" or "most recent" SQLCipher release do not
> describe the Syncbox pin. Syncbox uses the inventoried SQLCipher 4.12.0
> source and Apple CommonCrypto build documented in `UPSTREAM.md`.
