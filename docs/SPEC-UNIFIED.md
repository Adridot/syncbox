...
**Event web audio (approved 2026-09-07):** YouTube, YouTube Music and public SoundCloud metadata/audio use a separate component containing pinned yt-dlp/EJS, Deno, and focused audio-only FFmpeg/LAME. The base sidecar imports none of these dependencies. Metadata previews never download audio. Distribution is blocked until the complete Deno/native license inventory is verified; local experimental tests do not waive this gate.
