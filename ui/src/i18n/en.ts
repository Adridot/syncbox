export const en = {
  ...
  "placeholder": "Spotify, Deezer, YouTube or SoundCloud link",
  "preview": "Preview",
  ...
  "counts": "Entries: {total} · Selected: {selected} · Unavailable: {unavailable}",
  "selectAll": "Select all available",
  "selectNone": "Select none",
  "readd": "Allow new additions of removed or ignored tracks",
  ...
  "setup": "Open component settings",
  "recent": "Recent imports",
  "webTitle": "YouTube and SoundCloud",
  "webSub": "Optional audio component, installed separately. Public content access depends on the provider.",
  "webEnable": "Enable web audio",
  "webInstall": "Install web-audio component",
  ...
  "errors": {
    ...
    "web_audio_release_unavailable": "The web-audio component is not available for this application build.",
