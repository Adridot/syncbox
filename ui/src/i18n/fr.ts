...
export const fr: typeof en = {
  ...
  linkImport: {
    title: 'Ajouter un lien musical',
    placeholder: 'Coller un lien Spotify, Deezer, YouTube ou SoundCloud — titre, album ou playlist…',
    preview: 'Prévisualiser',
    busy: 'Résolution…',
    open: 'Ouvrir',
    chooseScope: 'Importer cette vidéo ou sa playlist ?',
    video: 'Cette vidéo',
    playlist: 'La playlist',
    resolving: 'Résolution de la musique liée…',
    entries: '{n} entrée | {n} entrées',
    committed: "{n} titre ajouté à l'événement. | {n} titres ajoutés à l'événement.",
    counts: '{selected} / {total} sélectionnés',
    unavailableCount: '{n} indisponible | {n} indisponibles',
    selectAll: 'Tout sélectionner (disponibles)',
    selectNone: 'Tout désélectionner',
    readd: 'Autoriser le réajout des titres retirés ou ignorés',
    unavailable: 'Indisponible',
    repeated: 'Doublon',
    removed: 'Retiré ou ignoré',
    alreadyPresent: 'Déjà dans cet événement',
    noDownload: "La confirmation ajoute les titres sélectionnés. Télécharge l'audio séparément si besoin.",
    confirm: 'Ajouter {n} titre | Ajouter {n} titres',
    retry: 'Réessayer la prévisualisation',
    dismiss: 'Fermer la prévisualisation',
    ...
    acquireSource: 'Télécharger depuis {provider}',
    webTitle: 'Acquisition YouTube / SoundCloud optionnelle',
    webSub:
      "Désactivée par défaut. Une fois activée, Syncbox installe séparément le composant yt-dlp épinglé (avec son FFmpeg et son runtime JavaScript) et ne l'utilise que pour les titres importés depuis ces liens. L'accès aux contenus publics dépend du fournisseur.",
    webEnable: "Activer l'acquisition audio web",
    webComponentLabel: 'Composant yt-dlp',
    webComponentInstalled: 'Installé à la révision épinglée.',
    webComponentMissing: "Non installé. Installe-le après avoir activé l'acquisition audio web.",
    webComponentUnavailable: "Aucune release du composant n'est encore fournie avec cette version de l'application.",
    webComponentUnsupported: 'Disponible uniquement sur Mac Apple silicon.',
    webInstall: 'Installer le composant',
    webInstalled: 'Composant audio web installé.',
    sourceQuality: 'Source : {codec} · {bitrate}',
    outputQuality: 'Sortie : {codec} · {rate}',
    transcoded: 'Converti dans un format pris en charge ; la qualité de la source est inchangée.',
    errors: {
      source_identity_mismatch: "Le fournisseur a renvoyé un autre enregistrement. Le titre lié n'a pas été remplacé.",
      exact_deezer_item_unavailable: 'Le titre Deezer exact lié est indisponible.',
      job_source_intent_changed: 'La source liée a changé. Relance un téléchargement pour ce titre.',
      published_source_identity_mismatch: 'Le téléchargement enregistré ne correspond pas à cet enregistrement lié.',
      operation_timeout: 'Le fournisseur a mis trop de temps à répondre. Réessaie plus tard.',
      incomplete_audio_output: "L'audio téléchargé est incomplet. Réessaie ce titre.",
      web_audio_component_missing: 'Installe le composant audio web dans les Réglages.',
      web_audio_component_disabled: "Active l'audio web dans les Réglages.",
      unsupported_platform: "L'acquisition audio web n'est disponible que sur Mac Apple silicon.",
      web_audio_release_unavailable: "Le composant audio web n'est pas disponible pour cette version de l'application.",
      deezer_component_upgrade_required: 'Mets à jour le composant Deezer pour télécharger le titre exact lié.',
      provider_metadata_unavailable: "La source n'a pas pu renvoyer de métadonnées. Réessaie plus tard.",
      provider_rate_limited: 'Le fournisseur limite les requêtes. Réessaie plus tard.',
      provider_item_unavailable: 'Ce titre est indisponible chez sa source.',
      provider_authentication_required: 'Le fournisseur exige un accès que ce composant ne prend pas en charge.',
      spotify_authentication_required: 'Connecte Spotify dans les Réglages pour importer des albums ou des playlists.',
      spotify_collection_inaccessible: 'Cette collection Spotify est inaccessible au compte connecté.',
      collection_items_inaccessible: "Le fournisseur n'a pas exposé les titres de cette collection.",
      collection_empty_or_inaccessible: "Le fournisseur n'a renvoyé aucun contenu accessible pour cette collection.",
      unsupported_music_resource: "Utilise un lien de titre, d'album ou de playlist pris en charge.",
      invalid_music_link: 'Saisis un lien musical HTTPS valide.',
      collection_item_limit: 'Cette collection dépasse la limite de 1 000 entrées.',
      collection_incomplete: "Le fournisseur a renvoyé moins d'entrées qu'il n'en annonce pour cette collection. Réessaie plus tard.",
      metadata_time_limit: 'La résolution des métadonnées a dépassé son délai. Essaie une collection plus petite.',
      operation_cancelled: "L'opération a été annulée.",
      live_stream_unsupported: 'Les directs et les diffusions à venir ne peuvent pas être importés.',
      provider_access_denied: "Le fournisseur a refusé l'accès à ce titre.",
      share_link_unavailable: 'Ce lien de partage est indisponible. Essaie son URL complète chez le fournisseur.',
      unsupported_network_destination: 'Le lien redirige vers une destination non prise en charge.',
      private_network_destination: 'Le lien du fournisseur mène à une destination non publique.',
      unsupported_share_target: 'Ce lien de partage ne mène pas à un titre, un album ou une playlist pris en charge.',
      invalid_video_id: "L'identifiant de vidéo YouTube de ce lien est invalide.",
      invalid_playlist_id: "L'identifiant de playlist YouTube de ce lien est invalide.",
      collection_page_limit: 'Cette collection demande plus de pages que Syncbox ne va en charger.',
      metadata_byte_limit: 'Le fournisseur a renvoyé plus de métadonnées que Syncbox ne va en stocker.',
      manifest_size_limit: 'Cette collection est trop volumineuse pour être stockée en prévisualisation.',
      invalid_collection_page: 'Le fournisseur a renvoyé une page de collection illisible.',
      invalid_manifest_source: 'La collection résolue ne correspond pas au lien soumis.',
      invalid_manifest_entry: 'Le fournisseur a renvoyé une entrée de collection illisible.',
      invalid_manifest_identity: "Le fournisseur a renvoyé une entrée dont l'identité n'a pas pu être vérifiée.",
      provider_timeout: "Le fournisseur n'a pas répondu à temps. Réessaie plus tard.",
      web_audio_component_failed: 'Le composant audio web a échoué. Réessaie, ou réinstalle-le dans les Réglages.',
      pending_import_limit: 'Trop de prévisualisations sont en cours de résolution. Attends la fin des résolutions.',
      request_identity_conflict: 'Cette demande de prévisualisation a déjà servi pour un autre lien. Colle à nouveau le lien.',
      invalid_request_token: 'Cette demande de prévisualisation est invalide. Colle à nouveau le lien.',
      event_unavailable: 'Cet événement est indisponible ou en cours de suppression.',
      import_not_ready: "Cette prévisualisation n'est pas prête à être confirmée.",
      import_not_retryable: 'Seule une prévisualisation en échec peut être relancée.',
      committed_import_immutable: 'Un import confirmé ne peut pas être fermé.',
      committed_selection_conflict: 'Cet import a déjà été confirmé avec une autre sélection. Lance une nouvelle prévisualisation pour ajouter des titres.',
      invalid_import_selection: 'Sélectionne au moins une entrée pour confirmer.',
      invalid_readd_selection: 'Les entrées retirées ne peuvent être rajoutées que si elles sont sélectionnées.',
      unknown_entry_key: 'La sélection ne correspond plus à cette prévisualisation. Recharge-la.',
    },
  },
  app: {
    title: 'Syncbox',
  ...
  backups: {
    ...
    migration: {
      ...
      lead: 'Déplace les fichiers vérifiés vers leur propriétaire permanent et nettoie leurs dossiers de jobs complets.',
      confirm: 'Traiter {n} élément | Traiter {n} éléments',
      doneFiles: '{n} ancien fichier migré | {n} anciens fichiers migrés',
      doneDirectories: '{n} dossier de job nettoyé | {n} dossiers de jobs nettoyés',
      event: '{n} fichier d’événement | {n} fichiers d’événement',
      collection: '{n} fichier de Collection | {n} fichiers de Collection',
      cleanup: '{n} dossier de job à nettoyer | {n} dossiers de jobs à nettoyer',
      ignored: '{n} élément laissé intact | {n} éléments laissés intacts',
      readyDetails: 'Fichiers prêts à migrer',
      cleanupDetails: 'Dossiers de jobs complets prêts à nettoyer',
      ...
      reason: {
        ...
        active_job: 'Le job de téléchargement est encore actif.',
        unsafe_directory: 'Le dossier du job est symbolique ou hors du stockage géré.',
        unowned_directory: 'Aucun job de téléchargement ne possède ce dossier.',
        unverified_destination: 'La destination publiée n’est pas référencée par son propriétaire.',
      },
    },
