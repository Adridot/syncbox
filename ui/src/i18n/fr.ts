...
export const fr: typeof en = {
  ...
  events: {
    ...
    del: {
      ...
      lead: 'Aperçu exact de ce qui sera supprimé :',
      playlistLine: 'Smart playlist Rekordbox',
      removed: 'retiré',
      artifactsLine: 'Dossier de staging + audio',
      filesCount: '{n} fichier | {n} fichiers',
      softDeleteLine: 'Tracks event-only (soft-supprimés)',
      keptLine: 'Tracks conservés (autres MyTags / protégés)',
  ...
  duplicates: {
    intro:
      'Choisis le morceau à {keep} (keeper) dans chaque groupe ; les autres seront supprimés. Le keeper suggéré suit une échelle de priorité ordonnée : protégé → fichier présent → bitrate → départage. Tu peux le changer.',
    keepWord: 'conserver',
    ...
    reason: {
      protected: 'conservé : track protégée',
  ...
  untagged: {
    intro: 'Tri par priorité : {junk} < {dup} < {alt} < {review}. La garde « protégé » s’applique à la suppression.',
    cat: {
      all: 'Tous',
      junk: 'junk',
