...
export const fr: typeof en = {
  linkImport: {
    ...
    placeholder: 'Lien Spotify, Deezer, YouTube ou SoundCloud',
    ...
    counts: 'Entrées : {total} · Sélectionnées : {selected} · Indisponibles : {unavailable}',
    selectAll: 'Tout sélectionner (disponibles)',
    selectNone: 'Tout désélectionner',
    readd: 'Autoriser un nouvel ajout des titres retirés ou ignorés',
    unavailable: 'Indisponible',
    repeated: 'Titre répété',
    ...
    setup: 'Ouvrir les réglages du composant',
    recent: 'Imports récents',
    webTitle: 'YouTube et SoundCloud',
    webSub: "Composant audio optionnel, installé séparément. L'accès aux contenus publics dépend du fournisseur.",
    webEnable: "Activer l'audio web",
    webInstall: 'Installer le composant audio web',
