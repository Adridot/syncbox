...
export const fr: typeof en = {
  ...
  events: {
    ...
    loadErrorTitle: 'Events indisponibles',
    emptyTitle: 'Aucun event',
    emptyBody: 'Crée un event depuis une playlist Spotify, ou à vide.',
    manualSource: 'Manuel',
    ...
    new: {
      title: 'Nouvel event',
      sub: 'Importe une playlist Spotify, ou crée un event vide et ajoute les titres à la main.',
      cta: '+ Nouvel event',
      ...
      createEmpty: 'Créer l’event vide',
    },
    apply: {
    ...
    del: {
      ...
      tagLine: 'MyTag de l’event retiré',
      ...
      action: {
        ...
        delete_with_event: 'Supprimer avec l’event',
        soft_delete_only: 'Soft-delete de la ligne uniquement',
      },
      note: 'Les migrations requises s’achèvent avant le nettoyage de l’event. L’identité Rekordbox et les métadonnées conservées restent inchangées. Requiert Rekordbox fermé.',
  ...
  missingCenter: {
    tagline: 'Récupérer les morceaux manquants — bibliothèque, events et collection, au même endroit.',
  ...
  settings: {
    ...
    transfer: {
      ...
      dataDesc: 'Réglages plus sources, events et historique en un instantané de base. L’import remplace les données actuelles — une sauvegarde de sécurité est faite d’abord.',
      export: 'Exporter…',
      import: 'Importer…',
